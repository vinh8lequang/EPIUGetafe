...
import MapLegendBarrio from "./MapLegendBarrio";
...
const VIEW_BARRIO = [40.305, -3.665];

function Map3({ mapRef, geojson }) {
  ...
  return (
    ...
    >
      ...
      <DynamicGeoJSON
        ...
        mapStyle={mapStyle1}
      />
      <MapLegendBarrio position={"bottomleft"} selection={selectionValue} />
    </MapContainer>
  );
}
